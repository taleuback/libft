...
ft_toupper.c ft_itoa.c ft_striteri.c ft_strmapi.c ft_itoa.c\
...
# ft_isascii.o ft_isdigit.o ft_isprint.o ft_memchr.o ft_memcmp.o\
...
# ft_strjoin.o ft_strlcat.o ft_strlcpy.o ft_strlen.o ft_strncmp.o\
# ft_strnstr.o ft_strrchr.o ft_strtrim.o ft_substr.o ft_tolower.o\
# ft_toupper.o ft_itoa.o ft_striteri.o ft_strmapi.o ft_itoa.o\
